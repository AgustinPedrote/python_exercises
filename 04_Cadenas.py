...
def check(word1: str, word2: str):
    # Palíndromos
    print(f"¿{word1} es un palíndromo?: {word1 == word1[::-1]}")  # Invierte la cadena
    ...
    def isogram(word: str) -> bool:
        ...
        # Verificar si todos los conteos son exactamente 1
        for count in word_dict.values():
            if count > 1:
                return False  # Si algún carácter aparece más de una vez, no es un isograma
        
        return True  # Si todos los caracteres aparecen una vez, es un isograma
